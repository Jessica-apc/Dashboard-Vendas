...
3. Substitua os dados da aba **Dados** pelos seus dados reais de vendas, mantendo as mesmas colunas.
4. O Dashboard e as tabelas da aba **Análise** são recalculados automaticamente, pois usam fórmulas (não valores fixos).
